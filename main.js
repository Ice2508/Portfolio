(() => {
   ...
   const videoSrc = [{
         ...
         text: [
            ...
            'Полная адаптивность, использование WebP для скорости, внедрение SEO-микроразметки (JSON-LD) и настроенная Yandex.Metrika.'
         ]
      },
      {
      ...
      },
      {
         ...
         text: [
            ...
            'Разработана система резервного копирования, позволяющая при наличии сети отправлять локальные данные на сервер.',
