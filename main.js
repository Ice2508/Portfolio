(() => {
   ...
   const videoSrc = [{
         ...
         text: [
            ...
            'Полная адаптивность, использование WebP для скорости, SEO-микроразметка (JSON-LD) и настроенная Yandex.Metrika.'
         ]
      },
      {
         ...
         text: [
            ...
            'Автоматическая генерация данных для билета (включая QR-коды) и сохранение статуса бронирования.'
         ]
      },
      {
         ...
         text: [
            ...
            'Внедрена система фильтрации по категориям и ингредиентам, а также реализована динамическая смена тем.'
         ]
      }
   ];
